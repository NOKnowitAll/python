...
intf = input('Введите режим работы интерфейса (access/trunk): ')
nintf = input('Введите тип и номер интерфейса: ')
nvlan = input('Введите номер влан(ов): ')




print('interface {}'.format(nintf))
print('\n'.join(template[intf]).format(nvlan))
